    ...
    public void initAspectAndPointcuts() {
        ...
        for (String beanDefinitionName : beanDefinitionNames) {
            ...
            ReflectionUtils.doWithMethods(clazz, method -> {
                ...
                if (after != null) {
                    String pointcutExpV2 = after.value();
                    // 借助pointcutParser解析切入点表达式
                    PointcutExpression pointcutExpressionV2 = pointcutParser.parsePointcutExpression(pointcutExpV2);
                    // 放入对应的缓存区
                    beforePointcutMethodMap.put(pointcutExpressionV2, method);
                }
            }, method -> {
